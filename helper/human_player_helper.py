            ...
            for col in range(cols - 2):
                if (
                    ...
                    if col > 0 and board[row][col - 1] == " ":
                        return (row, col - 1)
                    elif col < cols - 3 and board[row][col + 3] == " ":
                        return (row, col + 3)
            ...
            for row in range(rows - 2):
                if (
                    ...
                    if row > 0 and board[row - 1][col] == " ":
                        return (row - 1, col)
                    elif row < rows - 3 and board[row + 3][col] == " ":
                        return (row + 3, col)
        ...
        for row in range(rows - 2, 0, -1):
            for col in range(cols - 2):
                if (
                    ...
                    if row < rows - 1 and col > 0 and board[row + 1][col - 1] == " ":
                        return (row + 1, col - 1)
                    elif row > 2 and col < cols - 3 and board[row - 3][col + 3] == " ":
                        return (row - 3, col + 3)
